...
public final class FlightsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.xml2023.flights.Gateway.TokenValidanRequest,
      com.xml2023.flights.Gateway.TokenValidanResponse> getValidateTokenMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "validateToken",
      requestType = com.xml2023.flights.Gateway.TokenValidanRequest.class,
      responseType = com.xml2023.flights.Gateway.TokenValidanResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.xml2023.flights.Gateway.TokenValidanRequest,
      com.xml2023.flights.Gateway.TokenValidanResponse> getValidateTokenMethod() {
    io.grpc.MethodDescriptor<com.xml2023.flights.Gateway.TokenValidanRequest, com.xml2023.flights.Gateway.TokenValidanResponse> getValidateTokenMethod;
      ...
      synchronized (FlightsGrpc.class) {
        if ((getValidateTokenMethod = FlightsGrpc.getValidateTokenMethod) == null) {
          FlightsGrpc.getValidateTokenMethod = getValidateTokenMethod = 
              io.grpc.MethodDescriptor.<com.xml2023.flights.Gateway.TokenValidanRequest, com.xml2023.flights.Gateway.TokenValidanResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.xml2023.flights.Flights", "validateToken"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.xml2023.flights.Gateway.TokenValidanRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.xml2023.flights.Gateway.TokenValidanResponse.getDefaultInstance()))
  ...
  public static abstract class FlightsImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void validateToken(com.xml2023.flights.Gateway.TokenValidanRequest request,
        io.grpc.stub.StreamObserver<com.xml2023.flights.Gateway.TokenValidanResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.xml2023.flights.Gateway.TokenValidanRequest,
                com.xml2023.flights.Gateway.TokenValidanResponse>(
  ...
  public static final class FlightsBlockingStub extends io.grpc.stub.AbstractStub<FlightsBlockingStub> {
    ...
    /**
     */
    public com.xml2023.flights.Gateway.TokenValidanResponse validateToken(com.xml2023.flights.Gateway.TokenValidanRequest request) {
  ...
  public static final class FlightsFutureStub extends io.grpc.stub.AbstractStub<FlightsFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.xml2023.flights.Gateway.TokenValidanResponse> validateToken(
        com.xml2023.flights.Gateway.TokenValidanRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_VALIDATE_TOKEN:
          serviceImpl.validateToken((com.xml2023.flights.Gateway.TokenValidanRequest) request,
              (io.grpc.stub.StreamObserver<com.xml2023.flights.Gateway.TokenValidanResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class FlightsBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.xml2023.flights.Gateway.getDescriptor();
    }
