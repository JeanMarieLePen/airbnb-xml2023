<template>
    <div>
        <div style="margin-left:10px">
            <h2>Kreiranje novog smestaja</h2>
            ...
            <div style="width:50%" class="table-responsive">
                <table class="tbl">
                                ...
                                <tfoot >
                                    <tr>
                                        <td colspan="2" style="text-align: center;">
                                            <div>
                                                <button @click="addCenovnik()" class="btn btn-warning">Kreiraj</button>
                                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                <vueperslides id="slajdovi" v-show="smestaj.slike.length > 0" fixed-height="600px">
                            ...
                            <table style=" margin-bottom:100px;">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <!-- v-el:date-picker -->
                                            <datepicker ref="dtpckr" :min-date="new Date()" no-disabled-range :disabled-dates="disabledDates" @update:model-value="updateDatePicker" v-model="termin" range>
...
export default {
    ...
    methods:{
        ...
        updateDatePicker(selectedDate){
            ...
            // var elem = this.$refs.dtpckr;
            // elem.dispatchEvent(new Event("clear"));
            // this.$refs.dtpckr.clear;
            // document.getElementById("dtpckr").cleared();
        },
        uploadImage(e){
            let images = [];
